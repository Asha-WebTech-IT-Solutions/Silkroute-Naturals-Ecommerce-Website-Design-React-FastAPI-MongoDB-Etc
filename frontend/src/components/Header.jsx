...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50" data-testid="site-header">
      {/* Top marquee */}
      <div className="bg-charcoal text-ivory overflow-hidden border-b border-charcoal" style={{ background: "hsl(var(--foreground))" }}>
      ...
      >
        <div className="container-luxe flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-5">
            <button className="hidden md:inline-flex" aria-label="search" data-testid="search-button"><Search size={18} /></button>
